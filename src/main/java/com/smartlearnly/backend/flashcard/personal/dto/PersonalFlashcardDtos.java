...
public final class PersonalFlashcardDtos {
    public static final int MAX_ACTIVE_CARDS_PER_PERSONAL_SET = 500;
    ...
    public record BulkDeletePersonalFlashcardCardsRequest(
            ...
            @Size(max = MAX_ACTIVE_CARDS_PER_PERSONAL_SET, message = "Bulk delete must not exceed 500 flashcards")
    ...
    public record ReorderPersonalFlashcardCardsRequest(
            ...
            @Size(max = MAX_ACTIVE_CARDS_PER_PERSONAL_SET, message = "Reorder list must not exceed 500 flashcards")
            List<@NotNull(message = "Flashcard id must not be null") UUID> ids
    ) {
    }
