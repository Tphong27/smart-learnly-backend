...
@Slf4j
@Service
public class GeminiFlashcardGenerationService implements FlashcardGeminiGenerationService {
    ...
    public GenerationResult generate(GeminiGenerationRequest request) {
        ...
        int geminiCalls = 0;
        String selectableText = normalizeDocumentText(request == null ? null : request.sourceText());
