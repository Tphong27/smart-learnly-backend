...
public class TestQuestionService {
    ...
    /** Chuyển mapping câu hỏi sang DTO quản trị với nội dung và đáp án đầy đủ. */
    ...
    /** Chuyển mapping câu hỏi sang DTO an toàn để học viên làm bài. */
    ...
    /** Gán các trường định danh, thứ tự và số điểm dùng chung cho DTO quản trị. */
    ...
    /** Bổ sung nội dung, media và đáp án cho DTO quản trị của câu hỏi. */
    ...
    /** Lấy media đầu tiên theo loại để hiển thị cùng câu hỏi. */
    ...
    /** Bổ sung nội dung và media lựa chọn cho DTO học viên mà không trả đáp án đúng. */
