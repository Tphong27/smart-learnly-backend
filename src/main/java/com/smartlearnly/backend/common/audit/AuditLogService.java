...
public class AuditLogService {
    ...
    static AuditDomain domainFor(AuditAction action) {
        ...
        if (value.startsWith("FLASHCARD_")) return AuditDomain.CONTENT;
        if (value.startsWith("ASSIGNMENT_")) return AuditDomain.CONTENT;
        if (value.startsWith("SETTINGS_")) return AuditDomain.SYSTEM;
