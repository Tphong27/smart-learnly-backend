                ...
                http
                                ...
                                .authorizeHttpRequests(authorize -> authorize
                                                ...
                                                .requestMatchers(
                                                                ...
                                                                "/api/v1/courses/{courseId}/preview")
                                                .permitAll()
                                                // Resource management: ADMIN is system-only (settings/dashboard/users
                                                // via catch-all below).
                                                // Content roles: TMO / SME / TRAINER — method @PreAuthorize tightens
                                                // further.
                                                ...
                                                .hasAnyRole("TMO", "SME", "TRAINER")
                                                // Category list: TMO/SME/TRAINER; writes further restricted to TMO at
                                                // method level.
                                                .requestMatchers(
                                                ...
                                                // Uploads: trainer needs material/resource/media when customizing class
                                                // curriculum.
                                                .requestMatchers("/api/v1/admin/uploads/**")
                                                .hasAnyRole("TMO", "SME", "TRAINER")
                                                // Catch-all admin: settings, dashboard, audit (denied at controller),
                                                // other system paths.
