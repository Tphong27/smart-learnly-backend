package com.smartlearnly.backend.course.category.seed;
...
public class CategoryDevDataSeeder implements ApplicationRunner {
    ...
    // Tạo các category mẫu còn thiếu khi chạy profile dev.
    @Override
    @Transactional
    ...
    // Tạo một category mẫu theo slug và bỏ qua nếu đã tồn tại.
