...
public record SePayWebhookPayload(
    ...
    // Chuyển JSON webhook gốc thành dữ liệu chuẩn để luồng matching xử lý.
    public static SePayWebhookPayload from(JsonNode root) {
    ...
    // Đọc một trường chữ tùy chọn từ payload mà không làm lỗi khi SePay gửi null.
    ...
    // Chuẩn hóa trường số tiền từ cả kiểu number lẫn chuỗi số của SePay.
