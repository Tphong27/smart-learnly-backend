...
public class ClassSessionScheduleService {
    ...
    // Đồng bộ các phiên chưa diễn ra theo định nghĩa lịch mới của lớp.
    ...
    // Sinh các phiên mong muốn trong khoảng thời gian lớp từ mô tả lịch lặp.
    ...
    // Phân tích mô tả lịch text thành các khung giờ theo ngày trong tuần.
    ...
    // Tạo lỗi chuẩn cho mô tả lịch lớp không hợp lệ.
    ...
    // Kiểm tra lịch lớp đầy đủ và không có khung giờ chồng lấn trước khi lưu.
    ...
    // Xóa các phiên chưa diễn ra khi lớp bị hủy, xóa hoặc đổi lịch.
    ...
    // Ngăn lịch mới chồng lấn với các phiên tương lai của cùng giảng viên.
