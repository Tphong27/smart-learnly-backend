...
public record CreateClassRequest(
                ...
                // Khi có giá, vẫn kiểm tra khoảng hợp lệ 0..9999999999.99 với tối đa 2 số thập
                // phân.
                @NotNull(message = "Class price is required") @Positive(message = "Class price must be greater than 0") @DecimalMax(value = "9999999999.99", message = "Class price is too large") @Digits(integer = 10, fraction = 2, message = "Class price must contain at most 2 decimal places") BigDecimal price) {
}
