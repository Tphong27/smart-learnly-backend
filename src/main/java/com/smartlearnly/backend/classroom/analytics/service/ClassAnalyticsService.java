...
import com.smartlearnly.backend.classroom.analytics.dto.StudentPerformanceResponse;
...
public class ClassAnalyticsService {
        ...
        // Tổng hợp analytics lớp cho Admin/TMO sau khi lấy chi tiết lớp quản trị.
        ...
        @Transactional(readOnly = true)
        // Tổng hợp analytics lớp sau khi xác thực lớp được phân công cho giảng viên.
        ...
        // Kết hợp dữ liệu học viên, bài kiểm tra, bài tập và tiến độ thành phản hồi analytics.
        ...
        // Tính các chỉ số tiến độ, điểm và dấu hiệu cần chú ý của một học viên.
        ...
        // Lọc danh sách học viên rồi phân trang an toàn theo điều kiện analytics.
        ...
        // Kiểm tra học viên khớp từ khóa tên hoặc email đã chuẩn hóa.
        ...
        // Kiểm tra nhóm tiến độ được chọn cho học viên.
        ...
        // Kiểm tra chỉ báo inactive, nộp muộn hoặc không cảnh báo của học viên.
        ...
        // Sắp xếp học viên theo mức cần chú ý trước để màn hình ưu tiên can thiệp.
        ...
        // Chuẩn hóa giá trị lọc và trả về mặc định khi giá trị không hợp lệ.
        ...
        // Chuẩn hóa chuỗi tìm kiếm, biến giá trị rỗng thành chuỗi trống.
        ...
        // Tính tiến độ trung bình của danh sách học viên, trả 0 khi danh sách trống.
        ...
        // Chọn thời điểm gần nhất giữa hai hoạt động để xác định lần học cuối.
