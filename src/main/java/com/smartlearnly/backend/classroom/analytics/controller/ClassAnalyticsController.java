...
import com.smartlearnly.backend.classroom.analytics.service.ClassAnalyticsService;
...
public class ClassAnalyticsController {
    ...
    // Trả số liệu lớp khi giảng viên hiện tại được phân công cho lớp đó.
    ...
    // Gom các query parameter HTTP thành điều kiện lọc analytics thống nhất.
