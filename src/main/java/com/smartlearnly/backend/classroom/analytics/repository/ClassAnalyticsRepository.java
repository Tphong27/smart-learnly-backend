...
public class ClassAnalyticsRepository {
    ...
    // Truy vấn các học viên ghi danh còn hiệu lực làm dữ liệu gốc cho analytics.
    ...
    // Tổng hợp điểm trung bình bài kiểm tra của lớp.
    ...
    // Tổng hợp tỷ lệ nộp bài và nộp muộn theo số học viên còn hiệu lực.
    ...
    // Lấy chỉ số kiểm tra và bài tập theo từng học viên của lớp.
    ...
    // Tính phần trăm an toàn khi mẫu số có thể bằng 0.
    ...
    // Chuyển giá trị native query sang UUID theo các kiểu JDBC có thể trả về.
    ...
    // Chuyển số native query sang long với mặc định 0.
    ...
    // Chuyển số native query sang BigDecimal để tính điểm chính xác.
    ...
    // Chuyển thời điểm native query sang Instant nếu giá trị tồn tại.
    ...
    // Chuyển giá trị native query sang chuỗi nullable.
