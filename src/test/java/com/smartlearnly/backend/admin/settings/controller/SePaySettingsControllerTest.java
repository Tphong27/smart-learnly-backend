...
class SePaySettingsControllerTest {
    @Mock
    ...
    private SePaySettingsController controller;
    private UUID adminId;

    @BeforeEach
    void setUp() {
        AdminSettingsSupport support = new AdminSettingsSupport(settingsService, authenticatedUserResolver);
        controller = new SePaySettingsController(
                settingsService,
                auditLogService,
                support,
